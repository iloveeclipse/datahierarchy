...
public class RateIt {
    ...
    static boolean isProxyEnabled() {
        ServiceTracker proxyTracker = new ServiceTracker(DataHierarchyPlugin.getDefault()
    ...
    static boolean rate(int value, String comment) {
        ...
        try {
            ...
            DataHierarchyPlugin.showError("Failed to rate on EPIC...", e);
            return false;
        } finally {
            if (out != null) {
                try {
                    ...
                    DataHierarchyPlugin.logError("Failed to close stream...", e);
                }
            }
        }
    }
